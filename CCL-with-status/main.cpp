...
int main()
{
	...
	cv::line(daubing, cv::Point(daubing.cols - MARGIN_WIDTH-1, MARGIN_WIDTH-1), cv::Point(daubing.cols - MARGIN_WIDTH-1, daubing.rows - MARGIN_WIDTH-1), CV_RGB(255, 255,255), LINE_WIDTH);
